...
//! * [`standard`](https://mavlink.io/en/messages/standard.html) — a superset of the `minimal` dialect
...
//! is enabled. Unstable features are marked with <sup>`⍚`</sup> and could be changed in future
//! versions.
//!
